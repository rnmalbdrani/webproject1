    ...
    <body>
      ...
      <a href="Food.php"class="w3-bar-item w3-button w3-mobile w3-hover-red">الأنـظمة الغذائـية</a>
      <a href="mailto:web.contact122@gmail.com"class="w3-bar-item w3-button w3-mobile w3-hover-red">تواصـل معنا</a>
      </span>
      </div>

        <div class="w3-container w3-center">
      <h4 class="w3-animate-opacity"> إذا كنت مقبلاً على ممارسة الرياضة وإدخالها كنشاط أساسي الى يومك، وان كنت تريد تكوين صالة الجيم الخاصة بك داخل منزلك، هناك عدد من الأدوات والمعدات الرياضية الأساسية التي لا يمكن اتمام أي تمرين بدونهم، وسنعرّفك  على أهم المعدات الرياضية اللازمة لإتمام أي تمرين رياضي ناجح</h4>
